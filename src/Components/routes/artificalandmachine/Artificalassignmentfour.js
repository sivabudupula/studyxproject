...
const Artificalassignmentfour = ({ onTimeExpired }) => {
  ...
  return (
    ...
    <div className='assignmentone'>
        ...
        <div className='time-container'>
         ...
         <div className='artificalassignmentfour'>
         <br></br>
         Question 4: What is artificial intelligence (AI)?
         <br></br>
          </div>
      ...
      <div className='assignment'>
        <Link to='/artificialassignmentfive'>
...
export default Artificalassignmentfour;